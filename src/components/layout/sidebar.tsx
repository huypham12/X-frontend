'use client';
import { Home, Search, Bell, Mail, User as UserIcon, MoreHorizontal } from 'lucide-react';
  ...
  return (
    <aside className="w-[275px] shrink-0 border-r border-[#2F3336] hidden sm:flex flex-col p-4 min-h-screen sticky top-0">
      ...
      <nav className="flex-1 space-y-2 font-medium text-xl mt-2">
        ...
        <Button className="w-[90%] rounded-full h-14 font-bold text-lg mt-4 bg-[#1d9bf0] text-white hover:bg-[#1a8cd8]">
          Post
        </Button>
      </nav>
