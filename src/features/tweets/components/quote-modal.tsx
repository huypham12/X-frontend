...
export function QuoteModal({ tweet, isOpen, onClose }: QuoteModalProps) {
          ...
          <div className="flex gap-3 mt-2">
            ...
            <div className="flex-1">
              <textarea
                ...
                className="w-full bg-transparent text-xl placeholder-gray-500 text-white outline-none resize-none min-h-[50px] py-2"
                rows={2}
              />
              
              {/* Embedded original tweet */}
              <div className="mt-2 border border-[#2F3336] rounded-xl p-3 mb-2">
                <div className="flex items-center gap-1 text-sm pb-1">
                  <div className="w-5 h-5 rounded-full bg-[#333639] overflow-hidden flex-shrink-0">
                    {tweet.author?.avatar ? (
                  ...
                  <span className="font-bold">{tweet.author?.name || 'Unknown'}</span>
